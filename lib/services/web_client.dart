...
class WebClient implements ProfileRepository{
  ...
  var david = ProfileEntity(id: 'david',
      header: HeaderEntity(
          name: 'David Rahman',
      ...
      showcases: [
        ShowcaseEntity(url: 'https://images.unsplash.com/photo-1507335563142-a814078ce38c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=701&q=80'),
        ShowcaseEntity(url: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80'),
        ShowcaseEntity(url: 'https://images.unsplash.com/photo-1545186070-de624ed19875?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60'),
      ...
      experiences: [
        ...
        new ExperienceEntity(
            ...
            description: '• Review and check Instrumentation & Control subcontractor product basic design engineering, detail engineering, procurement, construction and commissioning of this project\n• Provides technical planning and general guidance for instrumentation in the execution of the project.'),
      ],
      projects: [
        new ProjectEntity(
            ...
            description: 'Represents the interface & coordination between construction, commissioning and operation group activities and includes all interface checks between all systems and subsystems in EPCC Senoro Gas Development Project with value more than 500 mio USD'),
        new ProjectEntity(
            title: 'Ruby Field Development',
            org: 'PT Meido Elang Indah, TOTAL E&P Indonesie',
            start: 1335971232,
            end: 1351868832,
            description: 'Ruby Tie In (RTI) project is part of Ruby Field Development operated by Pearl Oil Sebuku Limited (POSL). RTI will be executed by Total E&P Indonesie (TEPI) as Pearl Oil partner as well as operator for Senipah Facility. Gas maximum flowrate capacity from this block is 120 MMscfd.'
        ),
      ],
      certifications: [
