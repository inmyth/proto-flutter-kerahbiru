          ...
          return Container(
              ...
              child: Consumer<ProfileState>(builder: (context, profileState, child) {
                return ListView(children: [
                  ...
                  _Common(list: profileState.profile.experiences.map((e) => _CommonListItem(item: e)).toList(), title: "Experiences", isAddable: true, obj: Experience()),
                  _Common(list: profileState.profile.projects.map((e) => _ProjectItem(item: e)).toList(), title: "Projects", isAddable: false, obj: Project()),
                  _Certification(list: profileState.profile.certifications),
                  _Common(list: profileState.profile.educations.map((e) => _CommonListItem(item: e)).toList(), title: "Education", isAddable: false, obj: Education()),
                ]);
              }));
        },
      ),
...
class _Common extends StatelessWidget {
  ...
  final List<StatelessWidget> list;
  final String title;
  final isAddable;
      ...
      builder: (context, state, child) {
        return Container(
          ...
          child: OpenContainer(
            ...
            openBuilder: (BuildContext _, VoidCallback openContainer) => ProjectWorkerScreen(project: state.projects.first),
